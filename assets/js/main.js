...
const BDD = {
   etudiants: [{ nom: "diop", prenom: "diop", email: "alioud@gmail.com", telephone: "772157477", sexe: "M", dateNaiss: "2024-05-08", lieuNaiss: "pout", cni: "1761200000327", referentiielId: 0, promotionId: 0 }],
   referentiiel: [{ nom: "dev web", desc: "developpement web", status: "active" }],
   promotion: [{ nom: "p1", dateDebut: "2020-05-08", dateFin: "2021-05-08", etat: "desactive" }, { nom: "p2", dateDebut: "2021-12-08", dateFin: "2022-05-08", etat: "active" }],
   presence: [{}],
   utilisateur: [{}],
}
...
form.forEach(el => {
   if (checkVide(el.value) != 0) {
      ...
      el.nextElementSibling.innerText = "le champ "+el.attributes[1].value+" ne peut etre vide";
      error = 1;
   }
